...
define('ADMIN_PASSWORD', 'BsuEng@2025');
    ...
    <main>
        <div class="container">
            <section class="page-content animate-fade-in-up">
                <h2 class="text-2xl md:text-3xl font-bold text-bsu_dark_blue mb-4 text-center">تسجيل دخول لوحة التحكم</h2>
                <p class="text-center text-gray-600 mb-6">خاص بإدارة الشهادات</p>
                ...
                <form action="login.php" method="post" class="contact-form border-t border-gray-200 pt-6">
                    ...
                    <div class="text-center mt-4 p-3 bg-bsu_light_gray rounded-md border border-gray-200">
                        <small class="text-gray-600 text-sm">
                            ...
                            <strong class="text-bsu_dark_blue">admin</strong> / <strong class="text-bsu_dark_blue">BsuEng@2025</strong>
                        </small>
                    </div>
                </form>
            </section>
